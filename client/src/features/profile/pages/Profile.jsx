...
export default function Profile() {
  ...
  const INTEREST_OPTIONS = [
    ...
    "ðŸ¥¾ Hiking ðŸ¥¾",
    "ðŸ“š Reading ðŸ“š",
    "ðŸ‘¨â€ðŸ³ Cooking ðŸ‘¨â€ðŸ³",
    "ðŸ¶ Dogs ðŸ¶",
    "ðŸ± Cats ðŸ±",
    "ðŸ¤ Making friends ðŸ¤",
    "ðŸŒ™ Night drives ðŸŒ™",
    "ðŸŽ¨ Art ðŸŽ¨",
    "ðŸ§˜ Yoga ðŸ§˜",
    "âš½ Soccer âš½",
    "ðŸ Volleyball ðŸ",
        ...
        >
          <div className="profile-hangout-content">
            ...
            <div className="profile-hangout-meta">
              ...
              {locationLabel && (
                <span className="profile-hangout-meta-row">
                  <span className="profile-hangout-icon">ðŸ“</span>
            ...
            <div className="profile-modal-body">
              <div className="text-muted">
                {hangoutAction.mode === "delete"
                  ...
                  : "Youâ€™ll be removed from this hangout."}
              </div>
            </div>
