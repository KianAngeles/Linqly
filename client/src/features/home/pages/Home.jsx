...
import NotificationsList from "../../notifications/components/NotificationsList.jsx";
import { useNotificationsDropdownData } from "../../notifications/hooks/useNotificationsDropdownData.js";
import "./Home.css";
              ...
              >
                ...
                <div className="home-list-content">
                  ...
                  <div className="home-hangout-meta">
                    <span>{`\u{1F4CD} ${getHangoutDistanceText(h)}`}</span>
                    <span>{"\u2022"}</span>
                    <span>{`\u{1F465} ${getHangoutJoinedCount(h)} joined`}</span>
                    {isHangoutOngoing(h) ? (
                      <>
                        <span>{"\u2022"}</span>
